...
- Simulações de funcionalidades com JavaScript
- Integração visual com sistemas externos (ex.: chatbot ou links)

O objetivo é **apresentar a experiência do usuário**, sem a necessidade de backend completo.
